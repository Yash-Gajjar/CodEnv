...
<body>
 ...
 --%>
	...
	<!-- JS here -->
	<
	<c:url value="/resources/js/vendor/modernizr-3.5.0.min.js" />
	"></>
	<!-- Jquery, Popper, Bootstrap -->
	<
	<c:url value="/resources/js/vendor/jquery-1.12.4.min.js" />
	"></> <
	...
	<!-- Jquery Mobile Menu -->
	<
	<c:url value="/resources/js/jquery.slicknav.min.js" />
	"></>

	<!-- Jquery Slick , Owl-Carousel Plugins -->
	<
	<c:url value="/resources/js/owl.carousel.min.js" />
	"></> <
	<c:url value="/resources/js/slick.min.js" />
	"></>
	<!-- One Page, Animated-HeadLin -->
	<
	<c:url value="/resources/js/wow.min.js" />
	"></> <
	<c:url value="/resources/js/animated.headline.js" />
	"></> <
	<c:url value="/resources/js/jquery.magnific-popup.js" />
	"></>

	<!-- Date Picker -->
	<
	<c:url value="/resources/js/gijgo.min.js" />
	"></>
	<!-- Nice-select, sticky -->
	<
	<c:url value="/resources/js/jquery.nice-select.min.js" />
	"></> <
	<c:url value="/resources/js/jquery.sticky.js" />
	"></>
	<!-- Progress -->
	<
	<c:url value="/resources/js/jquery.barfiller.js" />
	"></>

	<!-- counter , waypoint,Hover Direction -->
	<
	<c:url value="/resources/js/jquery.counterup.min.js" />
	"></> <
	<c:url value="/resources/js/waypoints.min.js" />
	"></> <
	<c:url value="/resources/js/jquery.countdown.min.js" />
	"></> <
	<c:url value="/resources/js/hover-direction-snake.min.js" />
	"></>

	<!-- contact js -->
	<
	<c:url value="/resources/js/contact.js" />
	"></> <
	<c:url value="/resources/js/jquery.form.js" />
	"></> <
	<c:url value="/resources/js/jquery.validate.min.js" />
	"></> <
	<c:url value="/resources/js/mail-.js" />
	"></> <
	<c:url value="/resources/js/jquery.ajaxchimp.min.js" />
	"></>

	<!-- Jquery Plugins, main Jquery -->
	<
	<c:url value="/resources/js/plugins.js" />
	"></> <
	...
	<script src="<c:url value="/resources/js/hover-direction-snake.min.js" />"></script>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-3 col-md-4 col-sm-6">
						<div class="single-topic text-center mb-30">
							<div class="topic-img">
								<img src=" <c:url value="/resources/img/gallery/topic1.png" />"
									alt="" height="300px" weight="1500px">
					...
					<div class="col-lg-3 col-md-4 col-sm-6">
						<div class="single-topic text-center mb-30">
							<div class="topic-img">
								<img src=" <c:url value="/resources/img/gallery/topic2.png"/>"
									alt="" alt="" height="300px" weight="1500px">
								<div class="topic-content-box">
									<div class="topic-content">
										<h3>
					...
					<div class="col-lg-3 col-md-4 col-sm-6">
						<div class="single-topic text-center mb-30">
							<div class="topic-img">
								<img src=" <c:url value="/resources/img/gallery/topic3.png"/>"
									alt="" alt="" height="300px" weight="1500px">
								<div class="topic-content-box">
									<div class="topic-content">
										<h3>
				...
				<div class="row">
					<div class="col-lg-3 col-md-4 col-sm-6">
						<div class="single-topic text-center mb-30">
							<div class="topic-img">
								<img src=" <c:url value="/resources/img/gallery/topic4.png"/>"
									alt="" alt="" height="300px" weight="1500px">
								<div class="topic-content-box">
									<div class="topic-content">
										<h3>
					...
					<div class="col-lg-3 col-md-4 col-sm-6">
						<div class="single-topic text-center mb-30">
							<div class="topic-img">
								<img src=" <c:url value="/resources/img/gallery/topic5.png"/>"
									alt="" alt="" height="300px" weight="1500px">
								<div class="topic-content-box">
									<div class="topic-content">
										<h3>
				...
				<!-- <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img assets/img/gallery/topic6.png" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                  ...
                  <!---  <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img assets/img/gallery/topic7.png" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img assets/img/gallery/topic8.png" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
